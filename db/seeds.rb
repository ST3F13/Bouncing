...
goat_ad1 = GoatAd.create({ name:'Louloute', age: 6, address: "sci la bergerie, 685 Chemin du Mont Robert, 13290 Aix-en-Provence", latitude:"43.492487" , longitude: "5.393259", description: "Nice goat from Aix-en-Provence, has a nice behaviour with humans and can play with kids !", price_per_day: 299, features: "sociable"})
goat_ad2 = GoatAd.create({ name:'Elianemeusk', age: 8, address: "la ferme d'Agnis, 83870 Signes",  latitude:"43.317312", longitude: "5.895125", description: "4 times captain of the year, pilot in chief of spaceship IX, mother of 21 kids", price_per_day: 300, features: "space-traveller"})
goat_ad3 = GoatAd.create({ name:'John Seguin', age: 11, address: "Ferme les Seguins, 04210 Valensole", latitude:"43.863771" , longitude: "5.953728",description: "genuine fighter since 5 generations, golden Medal in Olympics Games in Bejin", price_per_day: 400, features: "fighter"})
goat_ad4 = GoatAd.create({ name:'Candia', age: 4, address: "Ferme Canteperdrix, 263 chemin de, 83390 Puget-ville", latitude: "43.268315",longitude: "6.098027", description: "Candia can deliver you 235 liters of milk every morning except sunday day off for her, can be useful for large families", price_per_day: 120, features: "milker"})
